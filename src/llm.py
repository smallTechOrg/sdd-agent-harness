...
Switching provider/model is a config change (ANALYST_LLM_PROVIDER/_MODEL), never a code change. The rest of the
...
def get_model():
    ...
    if not s.llm_api_key:
        raise RuntimeError("ANALYST_LLM_API_KEY is required for a real run (see README / spec/tech-stack.md).")
